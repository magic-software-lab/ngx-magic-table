...
export const PAGINATION_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => MagicPaginationComponent),
  multi: true
};
...
@Component({
  selector: 'magic-pagination',
  template: PAGINATION_TEMPLATE,
  providers: [PAGINATION_CONTROL_VALUE_ACCESSOR]
})
export class MagicPaginationComponent implements ControlValueAccessor, OnInit {
  public config: any;
  ...
  public constructor(renderer: Renderer, elementRef: ElementRef, paginationConfig: MagicPaginationConfig) {
